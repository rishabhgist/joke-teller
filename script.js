...
function tellMe(joke) {
    VoiceRSS.speech({
          key: 'ae410fbf9ee445c2ad37fd0e5cb208e7',
          src: joke,
          hl: 'en-us',
          v: 'Linda',
          r: 0,
...
async function getJoke() {
    let joke = '';
    const apiURL = 'https://v2.jokeapi.dev/joke/Any?blacklistFlags=nsfw,religious,political';
    try {
        ...
        tellMe(joke); // Passing joke to text-to-speech
        toggleButton(); // disable button when the audio is playing
    } catch (error) {
